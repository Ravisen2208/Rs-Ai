...
export default function Hero() {
    ...
    const mainImageUrl = 'https://plus.unsplash.com/premium_photo-1726374741245-45afc4530be3?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D';

    const galleryStripImages = [
        'https://plus.unsplash.com/premium_photo-1681487735113-5224f4e33cd2?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8YWRzfGVufDB8fDB8fHww',
        'https://plus.unsplash.com/premium_photo-1661598442345-245ee74b57b2?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDF8fGFkc3xlbnwwfHwwfHx8MA%3D%3D',
        'https://images.unsplash.com/photo-1770045564621-4dc1408185ac?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDd8dG93SlpGc2twR2d8fGVufDB8fHx8fA%3D%3D',
    ];
                ...
                <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                UPload product images and a modal photo - our AI instantly
                                produces professuional lifestyale imagery and short-form 
