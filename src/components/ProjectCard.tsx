        ...
        {forCommunity && (
         ...
         className="absolute right-3 top-3 sm:opacity-0
          ...
          <div className="flex flex-col items-end w-32 text-sm">
            ...
            bg-black/50 backdrop:backdrop-blur text-white border border-gray-500/50
     ...
     {/* product name and date */} 
       <div className="flex items-start justify-between gap-4">
         ...
         <div className="flex-1">
            ...
            {gen.updatedAt && (
                <p className="text-xs text-gray-500">Updated : {new Date(gen.updatedAt) .toLocaleString()}</p>
            )}
         </div>
